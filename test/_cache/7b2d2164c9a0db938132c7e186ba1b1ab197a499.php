<?php $__env->startSection('post::title', 'Spotlight, the movie: A personal view'); ?>
<?php $__env->startSection('post::date', 'February 27, 2016'); ?>
<?php $__env->startSection('post::brief', 'We worked for five months on that first story. That was a big investment for the Boston Globe — four reporters for 20 or so weeks. But it’s the kind of investment that can be needed for investigative work, and it paid off, beyond our wildest dreams.'); ?>
